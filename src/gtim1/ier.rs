...
impl W {
    ...
    #[doc = "Bit 3 - desc CC1"]
    #[inline(always)]
    pub fn cc1(&mut self) -> Cc1W<'_, IerSpec> {
        Cc1W::new(self, 3)
    }
    #[doc = "Bit 4 - desc CC2"]
    #[inline(always)]
    pub fn cc2(&mut self) -> Cc2W<'_, IerSpec> {
        Cc2W::new(self, 4)
    }
    #[doc = "Bit 5 - desc CC3"]
    #[inline(always)]
    pub fn cc3(&mut self) -> Cc3W<'_, IerSpec> {
        Cc3W::new(self, 5)
    }
    #[doc = "Bit 6 - desc CC4"]
    #[inline(always)]
    pub fn cc4(&mut self) -> Cc4W<'_, IerSpec> {
        Cc4W::new(self, 6)
    }
    #[doc = "Bit 9 - desc DIRCHANGE"]
    #[inline(always)]
    pub fn dirchange(&mut self) -> DirchangeW<'_, IerSpec> {
