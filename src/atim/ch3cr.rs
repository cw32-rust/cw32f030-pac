...
impl W {
    #[doc = "Bits 0:1 - desc BKSA"]
    #[inline(always)]
    pub fn bksa(&mut self) -> BksaW<'_, Ch3crSpec> {
        BksaW::new(self, 0)
    }
    #[doc = "Bits 2:3 - desc BKSB"]
    #[inline(always)]
    pub fn bksb(&mut self) -> BksbW<'_, Ch3crSpec> {
        BksbW::new(self, 2)
    }
    #[doc = "Bit 4 - desc CSA"]
    #[inline(always)]
    pub fn csa(&mut self) -> CsaW<'_, Ch3crSpec> {
        CsaW::new(self, 4)
    }
    #[doc = "Bit 5 - desc CSB"]
    #[inline(always)]
    pub fn csb(&mut self) -> CsbW<'_, Ch3crSpec> {
        CsbW::new(self, 5)
    }
    #[doc = "Bit 6 - desc BUFEA"]
    #[inline(always)]
    pub fn bufea(&mut self) -> BufeaW<'_, Ch3crSpec> {
        BufeaW::new(self, 6)
    }
    #[doc = "Bit 7 - desc BUFEB"]
    #[inline(always)]
    pub fn bufeb(&mut self) -> BufebW<'_, Ch3crSpec> {
        BufebW::new(self, 7)
    }
    #[doc = "Bit 8 - desc CIEA"]
    #[inline(always)]
    pub fn ciea(&mut self) -> CieaW<'_, Ch3crSpec> {
        CieaW::new(self, 8)
    }
    #[doc = "Bit 9 - desc CIEB"]
    #[inline(always)]
    pub fn cieb(&mut self) -> CiebW<'_, Ch3crSpec> {
        CiebW::new(self, 9)
    }
    #[doc = "Bit 10 - desc CDEA"]
    #[inline(always)]
    pub fn cdea(&mut self) -> CdeaW<'_, Ch3crSpec> {
        CdeaW::new(self, 10)
    }
    #[doc = "Bit 11 - desc CDEB"]
    #[inline(always)]
    pub fn cdeb(&mut self) -> CdebW<'_, Ch3crSpec> {
        CdebW::new(self, 11)
    }
    #[doc = "Bits 12:13 - desc CISB"]
    #[inline(always)]
    pub fn cisb(&mut self) -> CisbW<'_, Ch3crSpec> {
        CisbW::new(self, 12)
    }
    #[doc = "Bit 14 - desc CCGA"]
    #[inline(always)]
    pub fn ccga(&mut self) -> CcgaW<'_, Ch3crSpec> {
        CcgaW::new(self, 14)
    }
    #[doc = "Bit 15 - desc CCGB"]
    #[inline(always)]
    pub fn ccgb(&mut self) -> CcgbW<'_, Ch3crSpec> {
        CcgbW::new(self, 15)
    }
}
#[doc = "desc CH3CR\n\nYou can [`read`](crate::Reg::read) this register and get [`ch3cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch3cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
