...
impl W {
    ...
    #[doc = "Bit 3 - desc RTC"]
    #[inline(always)]
    pub fn rtc(&mut self) -> RtcW<'_, Apben1Spec> {
        RtcW::new(self, 3)
    }
    #[doc = "Bit 4 - desc WWDT"]
    #[inline(always)]
    pub fn wwdt(&mut self) -> WwdtW<'_, Apben1Spec> {
        WwdtW::new(self, 4)
    }
    #[doc = "Bit 5 - desc IWDT"]
    #[inline(always)]
    pub fn iwdt(&mut self) -> IwdtW<'_, Apben1Spec> {
        IwdtW::new(self, 5)
    }
    #[doc = "Bit 6 - desc SPI2"]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - desc I2C1"]
    #[inline(always)]
    pub fn i2c1(&mut self) -> I2c1W<'_, Apben1Spec> {
        I2c1W::new(self, 11)
    }
    #[doc = "Bit 12 - desc I2C2"]
    #[inline(always)]
    pub fn i2c2(&mut self) -> I2c2W<'_, Apben1Spec> {
        I2c2W::new(self, 12)
    }
}
