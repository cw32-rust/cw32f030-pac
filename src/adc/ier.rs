...
impl W {
    ...
    #[doc = "Bit 2 - desc EOA"]
    #[inline(always)]
    pub fn eoa(&mut self) -> EoaW<'_, IerSpec> {
        EoaW::new(self, 2)
    }
    #[doc = "Bit 3 - desc WDTL"]
    #[inline(always)]
    pub fn wdtl(&mut self) -> WdtlW<'_, IerSpec> {
        WdtlW::new(self, 3)
    }
    #[doc = "Bit 4 - desc WDTH"]
    #[inline(always)]
    pub fn wdth(&mut self) -> WdthW<'_, IerSpec> {
        WdthW::new(self, 4)
    }
    #[doc = "Bit 5 - desc WDTR"]
    #[inline(always)]
    pub fn wdtr(&mut self) -> WdtrW<'_, IerSpec> {
        WdtrW::new(self, 5)
    }
    #[doc = "Bit 6 - desc OVW"]
    #[inline(always)]
    pub fn ovw(&mut self) -> OvwW<'_, IerSpec> {
        OvwW::new(self, 6)
    }
}
