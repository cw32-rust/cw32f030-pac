...
impl W {
    ...
    #[doc = "Bit 9 - desc PIN9"]
    #[inline(always)]
    pub fn pin9(&mut self) -> Pin9W<'_, DirSpec> {
        Pin9W::new(self, 9)
    }
    #[doc = "Bit 10 - desc PIN10"]
    #[inline(always)]
    pub fn pin10(&mut self) -> Pin10W<'_, DirSpec> {
        Pin10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc PIN11"]
    #[inline(always)]
    pub fn pin11(&mut self) -> Pin11W<'_, DirSpec> {
        Pin11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc PIN12"]
    #[inline(always)]
    pub fn pin12(&mut self) -> Pin12W<'_, DirSpec> {
        Pin12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc PIN13"]
    #[inline(always)]
    pub fn pin13(&mut self) -> Pin13W<'_, DirSpec> {
        Pin13W::new(self, 13)
    }
    #[doc = "Bit 14 - desc PIN14"]
    #[inline(always)]
    pub fn pin14(&mut self) -> Pin14W<'_, DirSpec> {
        Pin14W::new(self, 14)
    }
    #[doc = "Bit 15 - desc PIN15"]
    #[inline(always)]
    pub fn pin15(&mut self) -> Pin15W<'_, DirSpec> {
        Pin15W::new(self, 15)
    }
}
