...
impl W {
    #[doc = "Bit 0 - desc PIN0"]
    #[inline(always)]
    pub fn pin0(&mut self) -> Pin0W<'_, DriverSpec> {
        Pin0W::new(self, 0)
    }
    #[doc = "Bit 1 - desc PIN1"]
    #[inline(always)]
    pub fn pin1(&mut self) -> Pin1W<'_, DriverSpec> {
        Pin1W::new(self, 1)
    }
    #[doc = "Bit 2 - desc PIN2"]
    #[inline(always)]
    pub fn pin2(&mut self) -> Pin2W<'_, DriverSpec> {
        Pin2W::new(self, 2)
    }
    #[doc = "Bit 3 - desc PIN3"]
    #[inline(always)]
    pub fn pin3(&mut self) -> Pin3W<'_, DriverSpec> {
        Pin3W::new(self, 3)
    }
    #[doc = "Bit 4 - desc PIN4"]
    #[inline(always)]
    pub fn pin4(&mut self) -> Pin4W<'_, DriverSpec> {
        Pin4W::new(self, 4)
    }
    #[doc = "Bit 5 - desc PIN5"]
    #[inline(always)]
    pub fn pin5(&mut self) -> Pin5W<'_, DriverSpec> {
        Pin5W::new(self, 5)
    }
    #[doc = "Bit 6 - desc PIN6"]
    #[inline(always)]
    pub fn pin6(&mut self) -> Pin6W<'_, DriverSpec> {
        Pin6W::new(self, 6)
    }
    #[doc = "Bit 7 - desc PIN7"]
    #[inline(always)]
    pub fn pin7(&mut self) -> Pin7W<'_, DriverSpec> {
        Pin7W::new(self, 7)
    }
    #[doc = "Bit 8 - desc PIN8"]
    #[inline(always)]
    pub fn pin8(&mut self) -> Pin8W<'_, DriverSpec> {
        Pin8W::new(self, 8)
    }
    #[doc = "Bit 9 - desc PIN9"]
    #[inline(always)]
    pub fn pin9(&mut self) -> Pin9W<'_, DriverSpec> {
        Pin9W::new(self, 9)
    }
    #[doc = "Bit 10 - desc PIN10"]
    #[inline(always)]
    pub fn pin10(&mut self) -> Pin10W<'_, DriverSpec> {
        Pin10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc PIN11"]
    #[inline(always)]
    pub fn pin11(&mut self) -> Pin11W<'_, DriverSpec> {
        Pin11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc PIN12"]
    #[inline(always)]
    pub fn pin12(&mut self) -> Pin12W<'_, DriverSpec> {
        Pin12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc PIN13"]
    #[inline(always)]
