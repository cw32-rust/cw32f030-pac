...
impl W {
    ...
    #[doc = "Bit 9 - desc PIN9"]
    #[inline(always)]
    pub fn pin9(&mut self) -> Pin9W<'_, IcrSpec> {
        Pin9W::new(self, 9)
    }
    #[doc = "Bit 10 - desc PIN10"]
    #[inline(always)]
    pub fn pin10(&mut self) -> Pin10W<'_, IcrSpec> {
        Pin10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc PIN11"]
    #[inline(always)]
    pub fn pin11(&mut self) -> Pin11W<'_, IcrSpec> {
        Pin11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc PIN12"]
    #[inline(always)]
    pub fn pin12(&mut self) -> Pin12W<'_, IcrSpec> {
        Pin12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc PIN13"]
    #[inline(always)]
